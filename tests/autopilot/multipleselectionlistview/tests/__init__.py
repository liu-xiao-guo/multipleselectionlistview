...
import multipleselectionlistview
...
class BaseTestCase(AutopilotTestCase):
    ...
    click_package = '{0}.{1}'.format('multipleselectionlistview', 'liu-xiao-guo')

    def setUp(self):
        super(BaseTestCase, self).setUp()
        self.launcher, self.test_type = self.get_launcher_and_type()
        self.app = multipleselectionlistview.TouchApp(self.launcher(), self.test_type)
